...
describe('<RoutePage />', () => {
  it('should set the activeAlert class if there is an alert and no patternId', () => {
    const props = {
      breakpoint: 'large',
      location: {
        pathname: '/linjat/HSL:1063/stajaliste/HSL:1063:0:01',
      },
      params: {
        routeId: 'HSL:1063',
  ...
  it('should start the real time client after mounting', () => {
    const props = {
      breakpoint: 'large',
      location: {
        pathname: '/linjat/tampere:32/stajaliste/tampere:32:1:01',
      },
      params: {
  ...
  describe('componentDidMount', () => {
    it('should ignore a missing pattern', () => {
      const props = {
        breakpoint: 'large',
        location: {
          pathname: '/linjat/HSL:1063/stajaliste/HSL:1063:0:02',
        },
        params: {
          routeId: 'HSL:1063',
